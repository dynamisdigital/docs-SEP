...
Mapa da fase com o status corrente de cada sprint (atualizado em 2026-08-03: web **concluido**,
incluindo o par corretivo de lockout (Sprint 33 + F-21) e a **F-22 mergeada, exceto a Task 6**, que
depende da Sprint 34; no backend a **Sprint 34 esta mergeada em develop+main**, quitando a divida que
o par corretivo registrou e destravando a Task F-22.6; no mobile a **M-17 esta mergeada**, e restam
M-14/M-15, bloqueadas por gate externo de hardware macOS). Cada
