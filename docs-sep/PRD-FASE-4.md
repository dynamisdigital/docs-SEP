...
| 37 | Correcao de divida / convencao | Normalizar a taxonomia de erro: decidir **o que o prefixo significa** e **qual e a convencao de sufixo**, deduplicar constantes de significado identico, renumerar as colisoes reais e re-prefixar `credores` | [`037`](../specs/fase-4/037-sprint-37-normalizacao-taxonomia-erro.md) | **planejada** (2026-09-01). Escopo que a 036 deixou **fora do perimetro**. **Preve ADR** — define convencao que vincula sprints futuras e atravessa os tres repos. Achados que a dimensionam: o prefixo **nao e identificador de modulo** e nao ha registro dele em lugar nenhum; `credores` ocupa a faixa `CRD` com **35 codigos contra 10** do `credito`, que lhe da nome; das 12 colisoes **2 nao sao colisao** (constante duplicada, corrige por deduplicacao); e o `PIX` tem **28 sufixos semanticos contra 3 numericos**, sendo convencao paralela e nao desvio. **Depende da 036 e da lista de excluidos da Task 36.7.** Provocou o **5o recuo** do backend da Fase 5 — mecanismo **encerrado em 2026-09-01** pela faixa por fase; a Fase 5 e fixa em 50-99 |
