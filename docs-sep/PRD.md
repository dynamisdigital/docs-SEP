...
- Documentacao: `docs-SEP/repos/sep-api/ONBOARDING.md` (fluxo, smoke manual, profile `local-wiremock`), `docs-SEP/repos/sep-api/SPRINT-6-PR.md` (descricao do PR consolidada), README atualizado com 4 caminhos de setup (Fake, Celcoin sandbox, local-wiremock, IT WireMock). Postman `docs-SEP/docs-sep/sep-api.postman_collection.json` ganhou pasta "Onboarding KYC PF (Sprint 6)" com 7 requests.
