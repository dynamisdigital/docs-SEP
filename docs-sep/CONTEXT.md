...
Com Sprint 0/F-Sprint 0/M-Sprint 0 (2026-05-04), Sprints 1, 2, 3, 4 e **5 backend** (Endurecimento de Seguranca, 2026-05-11, PR #27 mergeada) + **M-Sprints 1, 2, 3, 4 e 5 mobile** (2026-05-05/11; M-Sprint 5 = biometria stub + MFA verify + refresh rotativo + telas, PR #21 mergeada) + **F-Sprints 1, 2, 3, 4 e 5 web** (2026-05-06/11; F-Sprint 5 = MFA TOTP + step-up + refresh rotativo + telas, PR #22 mergeada) concluidas + **Follow-ups 5F-FIX-01..06** (2026-05-12; 5F-FIX-01/03/04/06 mergeados via PR #32, 5F-FIX-02 cross-stack + 5F-FIX-05 mobile aguardam push/PR manuais), com fluxo GitHub revisado (2026-05-06: feature → develop → main) e documentacao consolidada em `docs-sep/SEGURANCA.md` (incluindo §16 detalhando os follow-ups), os proximos passos provaveis sao:
...
- **Sprint 6 backend** (Epic 5 Onboarding KYC Pessoa Fisica, spec `specs/fase-2/006-sprint-6-onboarding-kyc-pessoa.md`) e o proximo passo natural da Fase 2. Antes de implementar, criar `steps-fase-2/backend/006-sprint-6-steps.md` just-in-time.
