...
Atualizacao operacional: documentacao especifica de repositorio agora fica em `docs-SEP/repos/<repo>/`.
Docs de modulo/API/backend, como `ONBOARDING.md`, `PLD.md`, `CREDITO.md`, `CONTRATOS.md`,
`CCB.md`, `COBRANCA.md`, `NOTIFICACOES.md` e `BACKOFFICE.md`, devem ser criados ou
atualizados em `docs-SEP/repos/sep-api/`. Os repositorios `sep-api`, `sep-app` e
`sep-mobile` nao devem recriar pastas `docs/`; suas raizes mantem apenas entrypoints como
