...
| M-11 | Epic 14/15 | Pix visivel ao usuario — desembolso do tomador (P1), status Pix da parcela (P2) e status Pix da operacao da credora (P3), integrados as telas de contrato/parcela/carteira (**implementada na branch `feature/msprint-11-pix-mobile` (Tasks M-11.1-M-11.5 + hotfix do review); pendente de merge em `develop`; consome os Gates P1-P3 da Sprint 26**) | [`211`](../specs/fase-3/211-msprint-11-pix-mobile.md) + [`steps`](../steps-fase-3/mobile/211-msprint-11-steps.md) | 5 |
