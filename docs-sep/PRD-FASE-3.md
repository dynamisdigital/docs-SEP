...
| F-11 | Epic 10/13 | Jornada empresa credora (**mergeada**, PR #57 -> develop; promovida a `main` via PR #58) | [`111`](../specs/fase-3/111-fsprint-11-credora-web.md) | 6 |
...
| F-13 | Epic 13/15 | Pix operacional no web (**mergeada**, PR #53 -> develop; promovida a `main` via PR #58) | [`113`](../specs/fase-3/113-fsprint-13-pix-web.md) + [`steps`](../steps-fase-3/web/113-fsprint-13-steps.md) | 5 |
...
| M-10 | Epic 14 | Empresa credora mobile (**concluída — mergeada em `develop` via PR #109 (`f51e6be`), não em `main`; Gate I1 fechado pela Sprint 25 backend PR #85; tab por presença sem role, interesse autoritativo, carteira read-only**) | [`210`](../specs/fase-3/210-msprint-10-credora-mobile.md) + [`steps`](../steps-fase-3/mobile/210-msprint-10-steps.md) | 6 |
