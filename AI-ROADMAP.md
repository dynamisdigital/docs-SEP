...
| Pix mobile, status de desembolso/pagamento da parcela/operacao credora, M-Sprint 11 | [`211`](specs/fase-3/211-msprint-11-pix-mobile.md) + [`step 211`](steps-fase-3/mobile/211-msprint-11-steps.md); Gates backend P1-P3 fechados pela Sprint 26 ([`026`](specs/fase-3/026-sprint-26-pix-leitura-owner-scoped.md), mergeada `develop` PR #87 + `main` PR #88); M-11 mobile mergeada em `develop` via PR #111 (squash `34f4f0f`; P1 contrato + P2 parcela + P3 carteira), NAO em `main` |
