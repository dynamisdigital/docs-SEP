...
| Mobile | [`repos/sep-mobile/README.md`](repos/sep-mobile/README.md) + [`docs-sep/MOBILE-SCREENS-PLAN.md`](docs-sep/MOBILE-SCREENS-PLAN.md) + [`docs-sep/New Design System Sep.md`](<docs-sep/New Design System Sep.md>) | `specs/fase-1/200-*` a `204-*`; `specs/fase-3/206-*` a `212-*`; Fase 4 [`213`](specs/fase-4/213-msprint-13-empacotamento-nativo-android.md)/[`steps`](steps-fase-4/mobile/213-msprint-13-steps.md); `steps-fase-1/mobile/`; `steps-fase-3/mobile/206-*`, `207-*`, `208-*`, `209-*`, `210-*`, `211-*`, `212-*` | 0003, 0009, 0010, 0011, 0015, 0019 |
...
| Android nativo, empacotamento, APK/AAB, deep link, back button, M-Sprint 13 (implementada na branch) | [`213`](specs/fase-4/213-msprint-13-empacotamento-nativo-android.md) + [`step 213`](steps-fase-4/mobile/213-msprint-13-steps.md) + [ADR 0019](adr/0019-baseline-capacitor-8-mobile.md) + [`repos/sep-mobile/README.md`](repos/sep-mobile/README.md) §Empacotamento nativo Android |
