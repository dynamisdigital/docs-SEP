...
| Teste manual de jornada | Base -> [`docs-sep/roteiros-teste/CENARIOS-TESTE-JORNADAS-USUARIO.md`](docs-sep/roteiros-teste/CENARIOS-TESTE-JORNADAS-USUARIO.md) (hub) -> [`docs-sep/roteiros-teste/ROTEIRO-00-AMBIENTE-E-MASSA.md`](docs-sep/roteiros-teste/ROTEIRO-00-AMBIENTE-E-MASSA.md) -> roteiro da familia -> app em `docs-sep/roteiros-teste/app/` -> doc operacional do modulo |
...
| jornada de usuario, teste manual, roteiro de teste, smoke local, checklist de QA, validacao fim-a-fim | [`docs-sep/roteiros-teste/CENARIOS-TESTE-JORNADAS-USUARIO.md`](docs-sep/roteiros-teste/CENARIOS-TESTE-JORNADAS-USUARIO.md) (hub) + [`docs-sep/roteiros-teste/`](docs-sep/roteiros-teste/); preparo de ambiente e bootstrap do primeiro ADMIN em [`ROTEIRO-00`](docs-sep/roteiros-teste/ROTEIRO-00-AMBIENTE-E-MASSA.md); execucao pelo app [`roteiros-teste/app/index.html`](docs-sep/roteiros-teste/app/index.html) (abre por duplo clique; `dados.js` gerado por `node gerar-dados.mjs`) |
