...
| `cobranca` | [`repos/sep-api/COBRANCA.md`](repos/sep-api/COBRANCA.md) + [`NOTIFICACOES.md`](repos/sep-api/NOTIFICACOES.md) | [`012`](steps-fase-2/backend/012-sprint-12-steps.md) (implementada) + [`013`](steps-fase-2/backend/013-sprint-13-steps.md) + [`109`](steps-fase-3/web/109-fsprint-9-steps.md) (web mergeada) | 0001, 0005, 0007, 0014 |
...
| empresa credora, cadastro credora, elegibilidade credora | [`repos/sep-api/CREDORES.md`](repos/sep-api/CREDORES.md) + [`016`](specs/fase-3/016-sprint-16-credora-foundation.md) (backend implementado) + web [`111`](specs/fase-3/111-fsprint-11-credora-web.md) (PLANEJADA — proxima web a implementar; ainda sem feature no `sep-app`) |
...
| Aplicacao do design system mobile, M-Sprint 12, splash/login/homes/shell/tabs | [`212`](specs/fase-3/212-msprint-12-new-design-system-mobile.md) + [`step 212`](steps-fase-3/mobile/212-msprint-12-steps.md) + [`115`](specs/fase-3/115-fsprint-15-aplicacao-design-system-web.md) + [`docs-sep/New Design System Sep.md`](<docs-sep/New Design System Sep.md>) |
