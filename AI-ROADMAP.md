...
| Aplicacao do design system web, F-Sprint 15, login/registro/dashboard/shell, tiles/chips/gradiente | [`115`](specs/fase-3/115-fsprint-15-aplicacao-design-system-web.md) (planejada) + [`step 115`](steps-fase-3/web/115-fsprint-15-steps.md) + [`repos/sep-app/DESIGN-SYSTEM.md`](repos/sep-app/DESIGN-SYSTEM.md) |
